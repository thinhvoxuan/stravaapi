 ...
 * @param optional nil or *CreateActivityOpts - Optional Parameters:
     ...
     * @param "Private" (optional.Int32) -  set to 1 to mark the resulting activity as private, ‘view_private’ permissions will be necessary to view the activity. If not specified, set according to the athlete’s privacy setting (recommended).
